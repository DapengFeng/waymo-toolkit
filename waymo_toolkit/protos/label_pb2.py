...
# source: waymo_toolkit/protos/label.proto
...
_LABEL_BOX_TYPE = _descriptor.EnumDescriptor(
    name="Type",
    full_name="waymo.toolkit.Label.Box.Type",
    filename=None,
    file=DESCRIPTOR,
    values=[
...
_LABEL_TYPE = _descriptor.EnumDescriptor(
    name="Type",
    full_name="waymo.toolkit.Label.Type",
    filename=None,
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(
...
_LABEL_DIFFICULTYLEVEL = _descriptor.EnumDescriptor(
    ...
    full_name="waymo.toolkit.Label.DifficultyLevel",
    filename=None,
    file=DESCRIPTOR,
    values=[
...
_LABEL_BOX = _descriptor.Descriptor(
    name="Box",
    full_name="waymo.toolkit.Label.Box",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="center_x",
            full_name="waymo.toolkit.Label.Box.center_x",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="center_y",
            full_name="waymo.toolkit.Label.Box.center_y",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="center_z",
            full_name="waymo.toolkit.Label.Box.center_z",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="length",
            full_name="waymo.toolkit.Label.Box.length",
            index=3,
            number=5,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="width",
            full_name="waymo.toolkit.Label.Box.width",
            index=4,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="height",
            full_name="waymo.toolkit.Label.Box.height",
            index=5,
            number=6,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="heading",
            full_name="waymo.toolkit.Label.Box.heading",
            index=6,
            number=7,
            type=1,
            cpp_type=5,
...
_LABEL_METADATA = _descriptor.Descriptor(
    name="Metadata",
    full_name="waymo.toolkit.Label.Metadata",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="speed_x",
            full_name="waymo.toolkit.Label.Metadata.speed_x",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="speed_y",
            full_name="waymo.toolkit.Label.Metadata.speed_y",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="accel_x",
            full_name="waymo.toolkit.Label.Metadata.accel_x",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="accel_y",
            full_name="waymo.toolkit.Label.Metadata.accel_y",
            index=3,
            number=4,
            type=1,
            cpp_type=5,
...
_LABEL = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="id",
            full_name="waymo.toolkit.Label.id",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="waymo.toolkit.Label.detection_difficulty_level",
            index=4,
            number=5,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="waymo.toolkit.Label.tracking_difficulty_level",
            index=5,
            number=6,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="waymo.toolkit.Label.num_lidar_points_in_box",
            index=6,
            number=7,
            type=5,
            cpp_type=1,
...
_POLYGON2DPROTO = _descriptor.Descriptor(
    name="Polygon2dProto",
    full_name="waymo.toolkit.Polygon2dProto",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="x",
            full_name="waymo.toolkit.Polygon2dProto.x",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="y",
            full_name="waymo.toolkit.Polygon2dProto.y",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="id",
            full_name="waymo.toolkit.Polygon2dProto.id",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
    ...
    dict(
        Box=_reflection.GeneratedProtocolMessageType(
            ...
            dict(
                ...
                __module__="waymo_toolkit.protos.label_pb2"
                # @@protoc_insertion_point(class_scope:waymo.toolkit.Label.Box)
            ),
        ),
        Metadata=_reflection.GeneratedProtocolMessageType(
            ...
            dict(
                ...
                __module__="waymo_toolkit.protos.label_pb2"
                # @@protoc_insertion_point(class_scope:waymo.toolkit.Label.Metadata)
            ),
        ),
        DESCRIPTOR=_LABEL,
        __module__="waymo_toolkit.protos.label_pb2"
        # @@protoc_insertion_point(class_scope:waymo.toolkit.Label)
    ),
)
...
Polygon2dProto = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        __module__="waymo_toolkit.protos.label_pb2"
        # @@protoc_insertion_point(class_scope:waymo.toolkit.Polygon2dProto)
    ),
)
