...
# source: waymo_extractor/protos/label.proto
...
_LABEL_BOX_TYPE = _descriptor.EnumDescriptor(
    name="Type",
    full_name="waymo.extractor.Label.Box.Type",
    filename=None,
    file=DESCRIPTOR,
    values=[
...
_LABEL_TYPE = _descriptor.EnumDescriptor(
    name="Type",
    full_name="waymo.extractor.Label.Type",
    filename=None,
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(
...
_LABEL_DIFFICULTYLEVEL = _descriptor.EnumDescriptor(
    ...
    full_name="waymo.extractor.Label.DifficultyLevel",
    filename=None,
    file=DESCRIPTOR,
    values=[
...
_LABEL_BOX = _descriptor.Descriptor(
    name="Box",
    full_name="waymo.extractor.Label.Box",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="center_x",
            full_name="waymo.extractor.Label.Box.center_x",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="center_y",
            full_name="waymo.extractor.Label.Box.center_y",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="center_z",
            full_name="waymo.extractor.Label.Box.center_z",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="length",
            full_name="waymo.extractor.Label.Box.length",
            index=3,
            number=5,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="width",
            full_name="waymo.extractor.Label.Box.width",
            index=4,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="height",
            full_name="waymo.extractor.Label.Box.height",
            index=5,
            number=6,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="heading",
            full_name="waymo.extractor.Label.Box.heading",
            index=6,
            number=7,
            type=1,
            cpp_type=5,
...
_LABEL_METADATA = _descriptor.Descriptor(
    name="Metadata",
    full_name="waymo.extractor.Label.Metadata",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="speed_x",
            full_name="waymo.extractor.Label.Metadata.speed_x",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="speed_y",
            full_name="waymo.extractor.Label.Metadata.speed_y",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="accel_x",
            full_name="waymo.extractor.Label.Metadata.accel_x",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="accel_y",
            full_name="waymo.extractor.Label.Metadata.accel_y",
            index=3,
            number=4,
            type=1,
            cpp_type=5,
...
_LABEL = _descriptor.Descriptor(
    name="Label",
    full_name="waymo.extractor.Label",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="id",
            full_name="waymo.extractor.Label.id",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="waymo.extractor.Label.detection_difficulty_level",
            index=4,
            number=5,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="waymo.extractor.Label.tracking_difficulty_level",
            index=5,
            number=6,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="waymo.extractor.Label.num_lidar_points_in_box",
            index=6,
            number=7,
            type=5,
            cpp_type=1,
...
_POLYGON2DPROTO = _descriptor.Descriptor(
    name="Polygon2dProto",
    full_name="waymo.extractor.Polygon2dProto",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="x",
            full_name="waymo.extractor.Polygon2dProto.x",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="y",
            full_name="waymo.extractor.Polygon2dProto.y",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="id",
            full_name="waymo.extractor.Polygon2dProto.id",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
    ...
    dict(
        Box=_reflection.GeneratedProtocolMessageType(
            ...
            dict(
                ...
                __module__="waymo_extractor.protos.label_pb2"
                # @@protoc_insertion_point(class_scope:waymo.extractor.Label.Box)
            ),
        ),
        Metadata=_reflection.GeneratedProtocolMessageType(
            ...
            dict(
                ...
                __module__="waymo_extractor.protos.label_pb2"
                # @@protoc_insertion_point(class_scope:waymo.extractor.Label.Metadata)
            ),
        ),
        DESCRIPTOR=_LABEL,
        __module__="waymo_extractor.protos.label_pb2"
        # @@protoc_insertion_point(class_scope:waymo.extractor.Label)
    ),
)
...
Polygon2dProto = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        __module__="waymo_extractor.protos.label_pb2"
        # @@protoc_insertion_point(class_scope:waymo.extractor.Polygon2dProto)
    ),
)
